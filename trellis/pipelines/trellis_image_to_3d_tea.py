# trellis/pipelines/trellis_image_to_3d_tea.py
from typing import *
...
class TrellisImageTo3DPipeline_tea(Pipeline):
    ...
    @staticmethod
    def from_pretrained(path: str) -> "TrellisImageTo3DPipeline_tea":
        pipeline = super(TrellisImageTo3DPipeline_tea, TrellisImageTo3DPipeline_tea).from_pretrained(path)
        new_pipeline = TrellisImageTo3DPipeline_tea()
    ...
    def sample_sparse_structure(
        ...
        use_f3c_teacache: bool = False,
        f3c_teacache_params: dict = {}
        ...
        elif use_f3c_teacache:
            from trellis.pipelines.samplers.f3c_teacache_sampler import F3CTeaCacheSampler
            sampler = F3CTeaCacheSampler(
                sigma_min=self.sparse_structure_sampler.sigma_min,
                pcsc_patch_size=flow_model.patch_size,
                **f3c_teacache_params
            )
            print(f"Using F3C-TeaCache Sampler with params: {f3c_teacache_params}")
    ...
    def run(
        ...
        teacache_params: dict = {},
        use_f3c_teacache_for_structure: bool = False,
        f3c_teacache_params: dict = {}
    ) -> dict:
        if preprocess_image:
        ...
        coords, z_s_result = self.sample_sparse_structure(
            ...
            use_f3c_teacache=use_f3c_teacache_for_structure,
            f3c_teacache_params=f3c_teacache_params
        )
